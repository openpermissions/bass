...
VALID_PARTS = [
    ('https://resolverhub.org', 'resolver_id'),
    ('https://resolverhub.com', 'resolver_id'),
    ('https://resol.ver.hub.com', 'resolver_id'),
    ('https://localhost', 'resolver_id'),
    ('https://localhost:8006', 'resolver_id'),
    ('https://resolver-hub', 'resolver_id'),
    ('https://RESOLVERhub', 'resolver_id'),
    ('https://resolverhub1', 'resolver_id'),
    ('https://9resolverhub', 'resolver_id'),
...
@pytest.mark.parametrize('hub_key', [
    'https://resolverhub.org/s1/chf/37cd1397e0814e989fa22da6b15fec60/asset/37cd1397e0814e989fa22da6b15fec60',
    'https://resolverhub.org/s1/chf/37cd1397e0814e989fa22da6b15fec60/offer/37cd1397e0814e989fa22da6b15fec60',
    'https://resolverhub.org/s1/chf/37cd1397e0814e989fa22da6b15fec60/agreement/37cd1397e0814e989fa22da6b15fec60',
    'https://resolverhub.org/s0/hub1/creation/testco/testcopictureid/10413373',
    'https://resolverhub.org/s0/hub1/asset/testco/testcopictureid/10413373',
    'https://resolverhub.org/s0/hub1/offer/testco/testcopictureid/001',
])
...
def test_is_hub_key_fails_missing_entity_id():
    assert not is_hub_key('https://resolverhub.org/s1/chf/37cd1397e0814e989fa22da6b15fec60/agreement')


def test_is_hub_key_fails_invalid_entity_type():
    assert not is_hub_key('https://resolverhub.org/s1/chf/37cd1397e0814e989fa22da6b15fec60/footype/e3cc6218db1711e5ab090242ac110013')


def test_parse_valid_hub_key_s0():
    parsed = parse_hub_key('https://reSOLverHuB.org/S0/hUb1/creATion/tEstCO/99TesTCOpiCtureID/ID-10413373')
    expected = {
        'resolver_id': 'https://resolverhub.org',
        'schema_version': 's0',
        'hub_id': 'hub1',
        'entity_type': 'creation',
        'organisation_id': 'testco',
        'id_type': '99testcopictureid',
...
def test_parse_valid_hub_key_s1():
    parsed = parse_hub_key('https://resolverhub.org/s1/chf/37cd1397e0814e989fa22da6b15fec60/agreement/e3cc6218db1711e5ab090242ac110013')
    expected = {
        'resolver_id': 'https://resolverhub.org',
        'schema_version': 's1',
        'hub_id': 'chf',
